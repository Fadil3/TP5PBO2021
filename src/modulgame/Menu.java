...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Muhammad Rayhan Fadillah - 1907998");
    ...
    private void Btn_PlayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_PlayActionPerformed
        ...
        String textFieldValue = TF_Username.getText();
        if(textFieldValue.isEmpty()){
            JOptionPane.showMessageDialog(null, "username belum dimasukkan", "Alert", JOptionPane.ERROR_MESSAGE);
        }else{
            Game ogame = new Game();
            ogame.setUsername(textFieldValue);
            this.dispose();
            HighScore.setModel(dbcon.readTable());
        }
